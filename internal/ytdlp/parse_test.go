...
func TestParseVideoItem(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "channel shelf result is skipped",
			input:       `{"_type":"url","ie_key":"YoutubeTab","id":"UCBJycsmduvYEL83R_U4JriQ","title":"Marques Brownlee","webpage_url":"https://www.youtube.com/channel/UCBJycsmduvYEL83R_U4JriQ"}`,
			wantID:      "",
			wantTitle:   "",
			wantChannel: "",
			wantViews:   0,
		...
		{
			name:        "channel result from handle at url is skipped",
			input:       `{"_type":"url","ie_key":"YoutubeTab","id":"UCx","title":"Some Channel","webpage_url":"https://www.youtube.com/@somechannel"}`,
			wantID:      "",
			wantTitle:   "",
			wantChannel: "",
			wantViews:   0,
